...
const Search = () => {
    ...
    useEffect(()=>{
        ...
        if(searchTermFromUrl || typeFromUrl || orderFromUrl || sortFromUrl || furnishedFromUrl || parkingFromUrl || offerFromUrl){
            setSidebarData({
        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center gap-2'>
                    ...
                    <input onChange={handleChange} value={sidebarData.searchTerm} type='text' placeholder='search term' id='searchTerm' className='rounded-lg p-3 w-full border'/>
                </div>
                ...
                <button className='bg-slate-700 text-white uppercase rounded-lg hover:opacity-95 p-3'>Search</button>
            </form>
        </div>
        <div className=''>
